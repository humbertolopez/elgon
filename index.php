<?php get_template_part('header') ?>
	...
	<section class="index-final block">
		<div class="video">
			<div class="img-video">
				<a href="https://youtu.be/B9zq8ec2T6Q" data-lightbox-type="ajax"><img src="<?php echo get_template_directory_uri(); ?>/img/index/video.jpg"></a>
			</div>
			<h2>Color y poesía</h2>
		</div>
		<div class="video">
			<div class="img-video">
				<a href="https://youtu.be/Iy7qGYGWUrA" data-lightbox-type="ajax"><img src="<?php echo get_template_directory_uri(); ?>/img/index/video_2.jpg"></a>
			</div>
		</div>
		<div class="video">
			<h3>Ver videos</h3>
			<div class="img-video">
				<a href="https://youtu.be/saI8KpbrbOE" data-lightbox-type="ajax"><img src="<?php echo get_template_directory_uri(); ?>/img/index/video_3.jpg"></a>
			</div>
			<div  class="img-video">
